...
function SWEP:IsUnderWater()
	if self:WaterLevel() < 3 then
		...
		if SERVER then
			...
			tes:SetKeyValue( "m_Color", "0 255 0" )
			tes:SetKeyValue("rendercolor", "0 255 0")
...
//		beam:SetKeyValue("dissolvetype", "0")
	...
	tent:SetKeyValue( "m_Color", "0 255 0" )
	tent:SetKeyValue("rendercolor", "0 255 0")
