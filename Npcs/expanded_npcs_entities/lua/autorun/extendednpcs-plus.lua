...
local NPC = { Name = "Houndeye (Pre-0.52 Alpha)", Class = "monster_houndeye", Model = "models/houndeye_prealpha_fixed.mdl", Category = Category} list.Set( "NPC", "monster_houndeye_prealpha", NPC)
local NPC = { Name = "Houndeye (0.52 Alpha)", Class = "monster_houndeye", Model = "models/houndeye_alpha_fixed.mdl", Category = Category} list.Set( "NPC", "monster_houndeye_alpha", NPC)
local NPC = { Name = "Houndeye (E3 1998)", Class = "monster_houndeye", Model = "models/houndeye_e3_fixed.mdl", Category = Category} list.Set( "NPC", "monster_houndeye_e3", NPC)
...
local NPC = { Name = "Chumtoad", Class = "monster_generic", Model = "models/chumtoad.mdl", Category = Category, NoDrop = true} list.Set( "NPC", "monster_chumtoad", NPC )
